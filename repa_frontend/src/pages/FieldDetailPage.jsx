        ...
        const fetchAllData = async () => {
            ...
            try {
                const [
                    ...
                    axios.get(`http://localhost:8000/topics/topic_author_corpus_counts/${topicName}`),
                    axios.get(`http://localhost:8000/corpus_topics/group_by_topic/${topicName}/stats`),
                    axios.get(`http://localhost:8000/author_topics/group_by_topic/${topicName}?page=${authorPage}&pageSize=${AUTHORS_PER_PAGE}`),
                    axios.get(`http://localhost:8000/corpus_topics/group_by_topic/${topicName}?page=${paperPage}&pageSize=${PAPERS_PER_PAGE}`)
                ]);
